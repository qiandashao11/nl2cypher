...
Natural-language question answering over a biomedical Neo4j knowledge graph.
The project trains and evaluates LoRA adapters that translate English
biomedical questions into Cypher, executes the query on a Gene-MeSH-Literature
graph, and writes grounded answers from the database result.
