...
checkpoint_path = "./lora_out_llama3_8b_r32_t2c2025_schema/checkpoint-600"  # replace with your latest checkpoint path

if os.path.exists(checkpoint_path):
    print(f"Resuming training, loading checkpoint: {checkpoint_path}")
