# ==================== train_lora_mistral.py (dataset-adapted) ====================
...
# -------- Basic configuration (Mistral-specific here) --------
MODEL_NAME = os.environ.get("BASE_MODEL", "mistralai/Mistral-7B-Instruct-v0.3")
DATA_PATH  = os.environ.get("DATA_PATH", "train.chat.jsonl")   # <- your chat JSONL
OUTPUT_DIR = os.environ.get("OUTPUT_DIR", "./lora_out_mistral_7b")
...
Guidelines:
- Prefer parameterized equality matches like {symbol:'TP53'} / {term:'cancer'}.
- Use DISTINCT when returning lists of entities.
...
# -------- Automatically select LoRA target layers (Mistral uses Llama-style module names) --------
